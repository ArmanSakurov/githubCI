...
import com.demoqa.model.Teacher;
...
public class FileParseTest {
    ...
    void csvTest() throws Exception {
        try (InputStream is = cl.getResourceAsStream("sample.csv");
            ...
            row = content.get(2);
            assertThat(row[0]).isEqualTo("Eroshenko");
            assertThat(row[1]).isEqualTo("Allure");
        }
    }
